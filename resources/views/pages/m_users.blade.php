                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="td-actions text-right">
                            ...
                            <button onclick="get_data({{$data->id}})" type="button" rel="tooltip"
                              class="btn btn-success btn-round" data-toggle="modal"
                              data-target="#editUser" data-original-title="Edit Data" title="Edit Data">
                              <i class="material-icons">edit</i>
                            </button>
                            <button onclick="delete_user({{$data->id}})" type="button" rel="tooltip"
                              class="btn btn-danger btn-round" data-original-title="Delete Data"
                              title="Delete Data">
                    ...
                    <div class="card-body">
                      <div class="form-group bmd-form-group">
                        <div class="input-group">
                          ...
                          <input name="nama_user" id="nama_user" type="text" class="form-control" placeholder="Name..." required="">
                        </div>
                      </div>
                      <div class="form-group bmd-form-group">
                        <div class="input-group">
                          <div class="input-group-prepend">
                            <div class="input-group-text"><i class="material-icons">maps</i></div>
                          </div>
                          <input name="alamat_user" id="alamat_user" type="text" class="form-control" placeholder="alamat..." required="">
                        </div>
                      </div>
                      <div class="form-group bmd-form-group">
                        <div class="input-group">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group bmd-form-group">
                      <div class="input-group">
                        ...
                        <input name="nama_user" id="edit_nama_user" type="text" class="form-control" placeholder="Name..." required="">
                      </div>
                    </div>
                    <div class="form-group bmd-form-group">
                        <div class="input-group">
                          ...
                          <input name="alamat_user" id="edit_alamat_user" type="text" class="form-control" placeholder="alamat..." required="">
                        </div>
                      </div>
                    <div class="form-group bmd-form-group">
                      <div class="input-group">
                        ...
                        <input name="username" id="edit_username" type="text" class="form-control" placeholder="Username..." required="">
                      </div>
                    </div>
                    ...
                    <div class="form-group bmd-form-group">
                      <div class="input-group">
                        ...
                        <input name="password" id="edit_password" type="password" placeholder="Password..." class="form-control" required="">
                      </div>
                    </div>                      
                    <div class="form-group bmd-form-group">
                      <div class="input-group">
      ...
      function get_data(id){
        ...
        $.ajax({
          ...
          success : function(data){
            ...
            $('#edit_nama_user').val(data[0].nama_user),
            $('#edit_alamat_user').val(data[0].alamat_user),
