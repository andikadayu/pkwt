                        ...
                        <div class="card-body">
                            <div class="form-group bmd-form-group">
                                <div class="input-group">
                                    ...
                                    <input name="nama_user" id="nama_user" type="text" class="form-control"
                            ...
                            <div class="form-group bmd-form-group">
                                <div class="input-group">
                                    ...
                                    <input name="alamat_user" id="alamat_user" type="text" class="form-control"
                            ...
                            <div class="form-group bmd-form-group">
                                <div class="input-group">
                                    ...
                                    <select name="role" id="role" class="selectpicker" data-style="btn btn-info"
                                        title="Role">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group bmd-form-group">
                                <div class="input-group">
                                    ...
                                    <input name="nama_user" id="edit_nama_user" type="text" class="form-control"
                                        placeholder="Name..." required="">
                                </div>
                            </div>
                            <div class="form-group bmd-form-group">
                                <div class="input-group">
                                    ...
                                    <input name="alamat_user" id="edit_alamat_user" type="text" class="form-control"
                                        placeholder="alamat..." required="">
                                </div>
                            </div>
                            <div class="form-group bmd-form-group">
                                <div class="input-group">
                                    ...
                                    <input name="username" id="edit_username" type="text" class="form-control"
                                        placeholder="Username..." required="">
                                </div>
                            </div>
                            ...
                            <div class="form-group bmd-form-group">
                                <div class="input-group">
                                    ...
                                    <input name="password" id="edit_password" type="password" placeholder="Password..."
                                        class="form-control" required="">
                                </div>
                            </div>
                            <div class="form-group bmd-form-group">
                                <div class="input-group">
                                    ...
                                    <select name="role" id="edit_role" class="selectpicker" data-style="btn btn-info"
                                        title="Role">
                                        <option value="Administrator">Administrator</option>
                                        <option value="HRD">HRD</option>
                                        <option value="Direktur">Direktur</option>
